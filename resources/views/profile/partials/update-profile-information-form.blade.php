<section class="bg-[#111827] rounded-[2rem] shadow-2xl shadow-black/50 border border-white/5 overflow-hidden">
    ...
    <form method="post" action="{{ route('password.update') }}" class="p-8 space-y-8">
        ...
        <div class="space-y-6">
            <div class="group">
                <label class="text-[10px] font-black text-slate-500 uppercase tracking-widest ml-1 mb-2 block">Clé actuelle</label>
                <input name="current_password" type="password" 
                       class="w-full bg-[#0a0f18] border-2 border-white/5 rounded-2xl py-4 px-6 text-sm text-white focus:border-[#005ab7] focus:ring-0 transition-all outline-none"
                       placeholder="Saisissez votre clé actuelle">
                <x-input-error :messages="$errors->updatePassword->get('current_password')" class="mt-2 ml-2" />
            </div>

            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div class="group">
                    <label class="text-[10px] font-black text-slate-500 uppercase tracking-widest ml-1 mb-2 block">Nouvelle clé</label>
                ...
                <div class="group">
                    <label class="text-[10px] font-black text-slate-500 uppercase tracking-widest ml-1 mb-2 block">Confirmation</label>
